...
Write-Output "############## Verify Script Signatures ###################"
...
Import-Module SitecoreInstallAzure -Force 

$commands = Get-Command -Module SitecoreInstallAzure
...
$readme = Join-Path -Path "$solutionFolder\Documentation" -ChildPath "sitecoreinstallazure.md"
